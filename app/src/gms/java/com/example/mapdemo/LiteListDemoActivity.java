...
public class LiteListDemoActivity extends AppCompatActivity {
    ...
    private static final NamedLocation[] LIST_LOCATIONS = new NamedLocation[]{
            new NamedLocation("Key Food Supermarket", new LatLng(40.821640, -73.945170)),
            new NamedLocation("Super Foodtown", new LatLng(40.823879, -73.944382)),
            new NamedLocation("Pioneer Supermarket", new LatLng(40.822790, -73.935540)),
